...
components data as it is just a python object. These types of GameSystem
...
cdef class GameSystem(CWidget):
    ...
    on the data of your Entity components. It will also manage assembling,
    ...
    The basic setup is that we will create Component objects and release them
